...
#arguments parsers
flags = tf.app.flags
#flag is value that acts as a signal for a function or a process.
...
#flags are basically run parameters for your model
#able to call the values anytime, anywhere
FLAGS = flags.FLAGS
